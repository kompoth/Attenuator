...
/** @cond DO_NOT_WANT */
#define LIBXIMC_VERSION 2.9.14
/** @endcond */


/** @cond DO_NOT_WANT */
#define LIBXIMC_PROTOCOL_VERSION 17.5
/** @endcond */
...
/**
	...
	*/
//@{
#define STATE_CONTR                    0x00003F 	/**< \english Flags of controller states. \endenglish \russian Флаги состояния контроллера. \endrussian */
#define STATE_ERRC                     0x000001 	/**< \english Command error encountered. \endenglish \russian Недопустимая команда. \endrussian */
#define STATE_ERRD                     0x000002 	/**< \english Data integrity error encountered. \endenglish \russian Нарушение целостности данных. \endrussian */
#define STATE_ERRV                     0x000004 	/**< \english Value error encountered. \endenglish \russian Недопустимое значение данных. \endrussian */
#define STATE_EEPROM_CONNECTED         0x000010 	/**< \english EEPROM with settings is connected. \endenglish \russian Подключена память EEPROM с настройками. \endrussian */
#define STATE_IS_HOMED                 0x000020 	/**< \english Calibration performed \endenglish \russian Калибровка выполнена \endrussian */
#define STATE_SECUR                    0x73FFC0 	/**< \english Flags of security. \endenglish \russian Флаги опасности. \endrussian */
#define STATE_ALARM                    0x000040 	/**< \english Controller is in alarm state indicating that something dangerous had happened. Most commands are ignored in this state. To reset the flag a STOP command must be issued. \endenglish \russian Контроллер находится в состоянии ALARM, показывая, что случилась какая-то опасная ситуация. В состоянии ALARM все команды игнорируются пока не будет послана команда STOP и состояние ALARM деактивируется. \endrussian */
#define STATE_CTP_ERROR                0x000080 	/**< \english Control position error(is only used with stepper motor). \endenglish \russian Контроль позиции нарушен(используется только с шаговым двигателем). \endrussian */
#define STATE_POWER_OVERHEAT           0x000100 	/**< \english Power driver overheat. \endenglish \russian Перегрелась силовая часть платы. \endrussian */
#define STATE_CONTROLLER_OVERHEAT      0x000200 	/**< \english Controller overheat. \endenglish \russian Перегрелась микросхема контроллера. \endrussian */
#define STATE_OVERLOAD_POWER_VOLTAGE   0x000400 	/**< \english Power voltage exceeds safe limit. \endenglish \russian Превышено напряжение на силовой части. \endrussian */
#define STATE_OVERLOAD_POWER_CURRENT   0x000800 	/**< \english Power current exceeds safe limit. \endenglish \russian Превышен максимальный ток потребления силовой части. \endrussian */
#define STATE_OVERLOAD_USB_VOLTAGE     0x001000 	/**< \english USB voltage exceeds safe limit. \endenglish \russian Превышено напряжение на USB. \endrussian */
#define STATE_LOW_USB_VOLTAGE          0x002000 	/**< \english USB voltage is insufficient for normal operation. \endenglish \russian Слишком низкое напряжение на USB. \endrussian */
#define STATE_OVERLOAD_USB_CURRENT     0x004000 	/**< \english USB current exceeds safe limit. \endenglish \russian Превышен максимальный ток потребления USB. \endrussian */
#define STATE_BORDERS_SWAP_MISSET      0x008000 	/**< \english Engine stuck at the wrong edge. \endenglish \russian Достижение неверной границы. \endrussian */
#define STATE_LOW_POWER_VOLTAGE        0x010000 	/**< \english Power voltage is lower than Low Voltage Protection limit \endenglish \russian Напряжение на силовой части ниже чем напряжение Low Voltage Protection \endrussian */
#define STATE_H_BRIDGE_FAULT           0x020000 	/**< \english Signal from the driver that fault happened \endenglish \russian Получен сигнал от драйвера о неисправности \endrussian */
#define STATE_CURRENT_MOTOR_BITS       0x0C0000 	/**< \english Bits indicating the current operating motor on boards with multiple outputs for engine mounting. \endenglish \russian Биты, показывающие текущий рабочий мотор на платах с несколькими выходами для двигателей. \endrussian */
#define STATE_CURRENT_MOTOR0           0x000000 	/**< \english Motor 0. \endenglish \russian Мотор 0. \endrussian */
#define STATE_CURRENT_MOTOR1           0x040000 	/**< \english Motor 1. \endenglish \russian Мотор 1. \endrussian */
#define STATE_CURRENT_MOTOR2           0x080000 	/**< \english Motor 2. \endenglish \russian Мотор 2. \endrussian */
#define STATE_CURRENT_MOTOR3           0x0C0000 	/**< \english Motor 3. \endenglish \russian Мотор 3. \endrussian */
#define STATE_WINDING_RES_MISMATCH     0x100000 	/**< \english The difference between winding resistances is too large \endenglish \russian Сопротивления обмоток отличаются друг от друга слишком сильно \endrussian */
#define STATE_ENCODER_FAULT            0x200000 	/**< \english Signal from the encoder that fault happened \endenglish \russian Получен сигнал от энкодера о неисправности \endrussian */
#define STATE_MOTOR_CURRENT_LIMIT      0x400000 	/**< \english Current limit exceeded \endenglish \russian Превышен предел по току \endrussian */
//@}
...
/** 
  ...
  */
	typedef struct
	{
		int Speed[25];	/**< \english Current speed. \endenglish \russian Текущая скорость. \endrussian */
		int Error[25];	/**< \english Current error. \endenglish \russian Текущая скорость. \endrussian */
...
/** 
  ...
  * @see get_measurements_t
  * @param id an identifier of device
  * @param[out] get_measurements structure with buffer and its length.
  * \endenglish
  * \russian
  ...
  * @see get_measurements_t
  * @param id идентификатор устройства
  * @param[out] get_measurements структура с буфером и его длинной.
  * \endrussian
  */
...
/** 
  ...
  * @param id an identifier of device
  * @param[out] the result of fields 0-3 concatenated defines the unique 128-bit device identifier.
  * \endenglish
  * \russian
  ...
  * @param id идентификатор устройства
  * @param[out] результат полей 0-3 определяет уникальный 128-битный идентификатор.
  * \endrussian
  */
