...
const
	...
	STATE_ERRD                      = $000002;
	STATE_ERRV                      = $000004;
	STATE_EEPROM_CONNECTED          = $000010;
	STATE_IS_HOMED                  = $000020;
	STATE_SECUR                     = $73FFC0;
	STATE_ALARM                     = $000040;
	STATE_CTP_ERROR                 = $000080;
	STATE_POWER_OVERHEAT            = $000100;
	STATE_CONTROLLER_OVERHEAT       = $000200;
	STATE_OVERLOAD_POWER_VOLTAGE    = $000400;
	STATE_OVERLOAD_POWER_CURRENT    = $000800;
	STATE_OVERLOAD_USB_VOLTAGE      = $001000;
	STATE_LOW_USB_VOLTAGE           = $002000;
	STATE_OVERLOAD_USB_CURRENT      = $004000;
	STATE_BORDERS_SWAP_MISSET       = $008000;
	STATE_LOW_POWER_VOLTAGE         = $010000;
	STATE_H_BRIDGE_FAULT            = $020000;
	STATE_CURRENT_MOTOR_BITS        = $0C0000;
	STATE_CURRENT_MOTOR0            = $000000;
	STATE_CURRENT_MOTOR1            = $040000;
	STATE_CURRENT_MOTOR2            = $080000;
	STATE_CURRENT_MOTOR3            = $0C0000;
	STATE_WINDING_RES_MISMATCH      = $100000;
	STATE_ENCODER_FAULT             = $200000;
	STATE_MOTOR_CURRENT_LIMIT       = $400000;
	...
	FEEDBACK_ENCODER        = $01;
	FEEDBACK_ENCODERHALL    = $03;
	FEEDBACK_EMF            = $04;
	FEEDBACK_NONE           = $05;

	FEEDBACK_ENC_REVERSE              = $01;
	FEEDBACK_HALL_REVERSE             = $02;
	...
	EXTIO_SETUP_MODE_OUT_MOTOR_FOUND    = $50;
...
type command_add_sync_in_action_t = record
		Position: integer;
		uPosition: integer;
		Time: cardinal;
end;

type command_add_sync_in_action_calb_t = record
		Position: single;
		Time: cardinal;
end;
...
type command_change_motor_t = record
		Motor: cardinal;
end;
...
function command_add_sync_in_action (id: Device; var the_command_add_sync_in_action: command_add_sync_in_action_t) : XimcResult; stdcall; external XimcDll;

function command_add_sync_in_action_calb (id: Device; var the_command_add_sync_in_action_calb: command_add_sync_in_action_calb_t; var calibration: calibration_t) : XimcResult; stdcall; external XimcDll;
...
function command_change_motor (id: Device; var the_command_change_motor: command_change_motor_t) : XimcResult; stdcall; external XimcDll;
